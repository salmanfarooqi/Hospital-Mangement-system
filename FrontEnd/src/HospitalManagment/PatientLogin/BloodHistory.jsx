...
function BloodHistory() {
  ...
  const getPatientInfo = async () => {
    ...
    setRecords([...patientDetail.bloodWardArr]);
  ...
  return (
    <>
      ...
      <div className="flex place-content-between min-w-[81vw]">
        {/* Page Name Heading */}
        <span className="font-bold text-2xl">Blood History</span>
                ...
                ? records.map((item, index) => {
                    return (
                      ...
                      >
                        ...
                        {/* Name */}
                        <td className="py-2 text-center">{item.doctorName}</td>
                        {/* Father Name */}
                        {/* <td className="py-2 text-center">{item.patientFatherName}</td> */}
                        {/* Blood Name  */}
                        <td className="py-2 text-center">{item.bloodGroup}</td>
                        {/* Blood Quantity  */}
                        <td className="py-2 text-center">
                          {item.bloodQuantity}
                        </td>
