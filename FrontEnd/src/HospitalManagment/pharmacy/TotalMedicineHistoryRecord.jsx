...
const TotalMedicineHistoryRecord = () => {
    ...
    <div>
      <div className="relative top-[10px]">
        ...
        px-4 py-1 ml-2 shadow-md border-none rounded-lg border-green-100"
            onChange={(e) => setmedicineRecorddata(e.target.value)}
          ></input>
        ...
        <div className=" shadow-md mt-[20px] ">
          <table className="w-[1100px]  border-2 ">
            ...
            <tbody>
              ...
              {
                //    data.filter((item)=>
                //       item.Namconst fdataNew =e.toLowerCase().includes(Data.toLowerCase()))

                medicineRecorddata.map((item, key) => (
...
export default TotalMedicineHistoryRecord;
