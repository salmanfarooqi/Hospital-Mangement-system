...
function DoctorLaboratoryHistory() {
  ...
  const getDoctorInfo = async () => {
    ...
    setRecords([...doctorDetail.testArr]);
  };
  ...
  return (
    <>
      ...
      <div className="flex place-content-between min-w-[81vw]">
        {/* Page Name Heading */}
        <span className="font-bold text-2xl">Laboratory History</span>
          ...
          <table className="border-collapse min-w-[81vw] shadow-lg">
            <thead className="text-black font-bold bg-gray-200">
              <tr>
                ...
                <th className="py-4">Report file</th>
                    ...
                    .map((item, index) => {
                      return (
                        ...
                        >
                          ...
                          {/* Test Name  */}
                          <td className="py-2 text-center">{item.testtype}</td>
                          {/* Test Description  */}
                          <td className="py-2 text-center">
                            {item.testDetail}
                          </td>
                          {/* Test Report file  */}
                          <td className="py-2 text-center">file</td>
                          {/* Appointment Date */}
...
export default DoctorLaboratoryHistory;
